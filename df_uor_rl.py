...
def main(args):
    ...
    log_dir = os.path.join(args.output, args.env_id, 'Ours',  "k_"+str(args.eval_k), "seed_"+str(args.seed), logid)
    ...
    actor_optim = Adam(actor.parameters(), lr=args.p_lr)
    critic_optim = Adam(critic.parameters(), lr=args.v_lr)
