...
register(
    ...
    entry_point = 'sunblaze_envs.mujoco:ModifiableRoboschoolHumanoid',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
# Walker2d
register(
    id = 'SunblazeWalker2d-v0',
    entry_point = 'sunblaze_envs.mujoco:ModifiableRoboschoolWalker2d',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
# Reacher
register(
    id='SunblazeReacher-v0',
    entry_point='sunblaze_envs.mujoco:ModifiableRoboschoolReacher',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
